...
ASMPTR(D2CLIENT, HoveredUnit_I, 0x51A80, 0);
ASMPTR(D2WIN, DrawTextBuffer, 0x12940, 0)
...
FUNCPTR(D2COMMON, GetItemMagicalMods, const char* __stdcall, (WORD wPrefixNum), -10248, -10174)
